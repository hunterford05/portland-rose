...
static NSString * const NAMES_DEMO = @"Action Button View Demo,Image Card View Demo,Palette Demo,Image Carousel View Demo,Tab Bar Controller Demo,Type Library Demo";
