...
static NSString * const NAMES_DEMO = @"Action Button View Demo,Image Card View Demo,Image Carousel View Demo,Palette Demo,Tab Bar Controller Demo,Type Library Demo";
